...
<header>
	<div class="container center-div shadow ">
		<div class="heading text-center mb-1 text-uppercase text-white"> ADD CUSTOMER DETAILS </div>
			...
			<div class="admin-form shadow p-2 ">
					<form action="addcustomerprocess.php" method="POST">
						...
						<div class="form-group">
							...
							<input type="text" name="customer_name" value="" class="form-control" autocomplete="off">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" name="total_point" value="" class="form-control" autocomplete="off">
						</div>
